  ...
  getnifty50frequent() {
    this.dataApi.getnifty50frequent().subscribe(data5 => {
      ...
      for (let val in nestedItems[3]['resultData']['data']) {
        ...
        this.niftypcrtime.push(new Date(nestedItems[3]['resultData']['data'][val]['time']).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', hour12: false }))
      }
      this.buildpcrgraph()
  ...
  getnifty5d() {
    this.http.get('https://priceapi.moneycontrol.com/pricefeed/techindicator/W/in%3BNSX?field=RSI').subscribe(data5 => {
      ...
      for (let val in nestedItems[2]['crossover']) {
        this.nifty50indicatorsw.push({ text1: nestedItems[2]['crossover'][val]['displayValue'], text3: nestedItems[2]['crossover'][val]['indication'], text2: nestedItems[2]['crossover'][val]['period'], text4: nestedItems[2]['crossover'][val]['period'] })
      }
      ...
      this.nifty50sentiments.push({ text1: [2]['sentiments']['indication'],text2:"Weekly"}) 
       
      
    });
     ////////////To get Nifty 1 week Price///////////////////////
      
     this.http.get('https://appfeeds.moneycontrol.com/jsonapi/market/graph&format=json&ind_id=9&range=1w&type=area').subscribe(data5 => {
      let nestedItems = Object.keys(data5).map(key => {
        return data5[key];
      });
  ...
  /////////////////////////////////////////////////////////////////
    ...
    getnifty1m() {
      this.http.get('https://priceapi.moneycontrol.com/pricefeed/techindicator/M/in%3BNSX?field=RSI').subscribe(data5 => {
        ...
        for (let val in nestedItems[2]['crossover']) {
          this.nifty50indicatorsm.push({ text1: nestedItems[2]['crossover'][val]['displayValue'], text3: nestedItems[2]['crossover'][val]['indication'], text2: nestedItems[2]['crossover'][val]['period'], text4: nestedItems[2]['crossover'][val]['period'] })
        }
        ...
        this.nifty50sentiments.push({ text1: [2]['sentiments']['indication'],text2:"Monthly"})
      });
  ...
  getniftytoday() {
    ...
    this.http.get('https://appfeeds.moneycontrol.com/jsonapi/market/graph&format=json&ind_id=9&range=1d&type=area').subscribe(data5 => {
      ...
      this.http.get('https://priceapi.moneycontrol.com/pricefeed/techindicator/D/in%3BNSX?field=RSI').subscribe(data5 => {
        ...
        console.log(nestedItems[2]['sentiments']['indication'])
        ...
        for (let val1 in nestedItems[2]['indicators']) {
          if (nestedItems[2]['indicators'][val1]['id'] != 'bollinger') {
            ...
            this.nifty50sentiments.push({ text1: [2]['sentiments']['indication'],text2:"Daily"})
